...
class AdapterAddressList(private val context: Context,private val addressList: MutableList<AddressDetail>, val select:Select) : RecyclerView.Adapter<AdapterAddressList.MyTopServices>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyTopServices {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.list_address_item, parent, false)
