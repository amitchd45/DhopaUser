...
class AdapterPaymentHistory: RecyclerView.Adapter<AdapterPaymentHistory.MyTopServices>() {
...
//            image.setImageResource(services.image)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyTopServices {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.list_item_payment, parent, false)
